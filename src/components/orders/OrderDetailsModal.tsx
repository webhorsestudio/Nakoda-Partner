                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{order.commission_percentage ? `${order.commission_percentage}%` : 'N/A'}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Taxes and Fee:</span>
                            <span className="font-medium">{order.taxes_and_fees ? `₹${order.taxes_and_fees}` : 'N/A'}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg">
                        <h4 className="font-medium text-blue-900 mb-3">Partner Information</h4>
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            <span className="text-gray-600">Partner Name:</span>
                            <span className="font-medium">{order.partner || 'N/A'}</span>
                          </div>
                          <div className="flex justify-between">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {order.advance_amount ? 
                                `₹${order.advance_amount.includes('|') ? order.advance_amount.split('|')[0] : order.advance_amount}` 
                                : 'N/A'
                              }
                            </span>
                          </div>
